...
class _VistaDashboardCentralState extends State<VistaDashboardCentral>
  ...
  Future<void> _recargar() async {
    final futuro = _cargarDashboard();
    setState(() {
      futuroDashboard = futuro;
    });
              ...
              return Column(
                ...
                children: [
                  _PanelAtencionOperativa(
                    datos: datos,
                    onAbrirMovimientos: widget.onAbrirMovimientos,
                    onAbrirGuardias: widget.onAbrirGuardias,
                    onAbrirSoporte: widget.onAbrirSoporte,
                  ),
                  ...
                  SelectorPeriodoDashboard(
                    seleccionado: periodoResumen,
                    onChange: _cambiarPeriodoResumen,
                  ),
                  const SizedBox(height: 12),
                  ...
                  _EstadoBicicleterosOperativo(
                    ...
                    onVerGuardias: widget.onAbrirGuardias,
                  ),
                  const SizedBox(height: 16),
                  ...
                  _ActividadRecienteDashboard(
                    ...
                    onVerMovimientos: widget.onAbrirMovimientos,
                  ),
                ],
              );
            },
...
class _DatosDashboardCentral {
  const _DatosDashboardCentral({
...
class _EstadoCampusCentral extends StatelessWidget {
  ...
  final _DatosDashboardCentral datos;
    ...
    return GridIndicadoresCentral(
      indicadores: [
        ...
        IndicadorCentral(
          ...
          colorIcono: ColoresUbb.azulInstitucional,
        ),
        IndicadorCentral(
